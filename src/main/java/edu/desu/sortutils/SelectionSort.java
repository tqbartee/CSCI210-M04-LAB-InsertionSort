...
import static edu.desu.helperstaticmethods.HelperStaticMethods.generateReverseSequentialIntArray;
...
public final class SelectionSort {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // 3. Call the appropriate method in HelperStaticMethods.java based on user choice.
            int[] data;
            switch (optionInput) {
                case "1":
